...
-- ((B C)* | A): optional group as a non-last branch; a zero-match (B C)* must
-- not spill into the following A branch.
...
-- iterations, giving an empty match where no A is present.
